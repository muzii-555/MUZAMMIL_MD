  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(
        config.MENU_IMAGE_URL || "https://files.catbox.moe/s3cve5.jpg",
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝙈𝙐𝙕𝘼𝙈𝙈𝙄𝙇-𝙈𝘿",
            body: config.DESCRIPTION || "MOST POPULAR",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/s3cve5.jpg", // Static image URL
            sourceUrl: "https://wa.me/message/923375626980",
